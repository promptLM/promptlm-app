...
/**
 * Fail-fast precondition for Testcontainers-backed acceptance tests.
 * <p>
 * Pings the Docker daemon before any {@code @WithGitea} / {@code @WithArtifactory}
 ...
 * timing out ~4 minutes into container init.
 */
public final class DockerAvailableExtension implements BeforeAllCallback {
    ...
    private static final String REMEDIATION_HINT = """
            Docker is not reachable from this JVM. The acceptance suite needs a working Docker daemon for Testcontainers (Gitea, Artifactory).
