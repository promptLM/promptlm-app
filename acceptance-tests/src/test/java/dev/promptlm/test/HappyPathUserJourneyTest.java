...
public class HappyPathUserJourneyTest {
    ...
    void beforeAll(@Gitea GiteaContainer giteaContainer, @Artifactory ArtifactoryContainer artifactory) throws IOException {
        ...
        baseUrl = JarStarter.testJarApplication(giteaUrl, giteaUsername, giteaToken);
    ...
    static class JarStarter {

        private static String originalUserHome;

        private static boolean isLocal = false;
        static void switchUserHome() {
            originalUserHome = System.getProperty("user.home");
            System.setProperty("user.home", userHome.toString());
        }

        public static String testJarApplication() throws IOException {
            JarStarter.switchUserHome();
            Files.deleteIfExists(getUserHome().resolve(".promptlm/context.json"));
            return TestApplicationManager.startApplication(getUserHome());
        }

        public static String testJarApplication(String giteaUrl, String username, String password) throws IOException {
            JarStarter.switchUserHome();
            Files.deleteIfExists(getUserHome().resolve(".promptlm/context.json"));
            return TestApplicationManager.startApplicationWithGitea(getUserHome(), giteaUrl, username, password);
        }

        public static String testRunningApplication() {
            isLocal = true;
