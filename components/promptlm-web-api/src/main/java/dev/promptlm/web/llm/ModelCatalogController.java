...
@Tag(name = "LLM Catalog", description = "Catalog of available LLM vendors and models")
public class ModelCatalogController {
    ...
    @Operation(summary = "Get model catalog", description = "Returns the list of available vendors and models.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Model catalog",
